...
func init() {
	proto.RegisterType((*OnosRequest)(nil), "main.OnosRequest")
	proto.RegisterType((*OnosReply)(nil), "main.OnosReply")
}
...
var fileDescriptor_08b859915553faa1 = []byte{
	...
	0xcc, 0xcc, 0x53, 0x52, 0xe7, 0xe2, 0x06, 0xc9, 0x04, 0xa5, 0x16, 0x96, 0xa6, 0x16, 0x97, 0x08,
	...
	0x50, 0x41, 0x4e, 0xa5, 0x12, 0x83, 0x13, 0x67, 0x14, 0xd8, 0x61, 0x1d, 0x8c, 0x8c, 0x49, 0x6c,
	0x60, 0x87, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x6d, 0x7e, 0x08, 0x31, 0xbc, 0x00, 0x00,
	0x00,
}
...
func (c *onosServerClient) EvpnRoute(ctx context.Context, in *OnosRequest, opts ...grpc.CallOption) (*OnosReply, error) {
	out := new(OnosReply)
	err := c.cc.Invoke(ctx, "/main.OnosServer/EvpnRoute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OnosServer_EvpnRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.OnosServer/EvpnRoute",
	}
